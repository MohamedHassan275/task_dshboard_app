    ...
    return CustomStatusBarColorWidget(
      ...
      widget: RefreshIndicator(
        onRefresh: () async{
          ...
          HomeCubit.get(context).userContentService();
        },
        child: Scaffold(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 25.h,),
                      Column(
                        children: [
                          /// when isCategorySelected is true category widget is shown
                          Visibility(
                             visible: isCategorySelected == true ? true : false,
                              child: const CategoryHomeWidget()),
                          /// when isOrderSelected is true order widget is shown
                          Visibility(
                             visible: isOrderSelected == true ? true : false,
                              child: const OrderHomeWidget()),
                          /// when isServiceSelected is true service widget is shown
                          Visibility(
                             visible: isServiceSelected == true ? true : false,
